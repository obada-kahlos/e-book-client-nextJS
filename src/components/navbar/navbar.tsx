...
const Navbar = () => {
  return (
    <div className="navbar px-[120px] sticky top-0 left-0 w-full bg-[#1d56ab] text-[white]">
      <div className="navbar-start text-[#fff]">
        <a className="btn btn-ghost normal-case text-xl">BookStore</a>
      </div>
      <div className="navbar-center text-[#fff]">
      ...
      <div className="navbar-end">
        <div className="flex gap-4">
          <label className="btn btn-ghost btn-circle text-[#fff] swap swap-rotate">
            <input type="checkbox" />
